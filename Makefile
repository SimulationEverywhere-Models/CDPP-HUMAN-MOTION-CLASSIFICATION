...
LDFLAGS+=-L. -g
#^|
EXAMPLESOBJS=  cameras.o classifier.o pc.o preprocessor.o register.o queue.o main.o generat.o cpu.o transduc.o distri.o com.o linpack.o debug.o trafico.o
#/
...
#^|
cameras.o: /cygdrive/C/eclipse/workspace/HMC/cameras.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
classifier.o: /cygdrive/C/eclipse/workspace/HMC/classifier.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
pc.o: /cygdrive/C/eclipse/workspace/HMC/pc.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
preprocessor.o: /cygdrive/C/eclipse/workspace/HMC/preprocessor.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
register.o: /cygdrive/C/eclipse/workspace/HMC/register.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
#
...
#^|
cameras.o: /cygdrive/C/eclipse/workspace/HMC/cameras.cpp \
 /cygdrive/C/eclipse/workspace/HMC/cameras.h \
...
classifier.o: /cygdrive/C/eclipse/workspace/HMC/classifier.cpp \
 /cygdrive/C/eclipse/workspace/HMC/Classifier.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/atomic.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/model.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/port.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/modelid.h \
...
pc.o: /cygdrive/C/eclipse/workspace/HMC/pc.cpp \
 /cygdrive/C/eclipse/workspace/HMC/pc.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/atomic.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/model.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/port.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/modelid.h \
 ...
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/ltranadm.h
preprocessor.o: /cygdrive/C/eclipse/workspace/HMC/preprocessor.cpp \
 /cygdrive/C/eclipse/workspace/HMC/preprocessor.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/atomic.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/model.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/port.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/modelid.h \
